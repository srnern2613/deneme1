// ============================================================================
// DOSYA ADI: lib/listening_exercise_screen.dart
// AÇIKLAMA: Sadece Dinleme — PREMIUM mod. Kelimenin yazısı gösterilmeden
//           TTS ile otomatik telaffuz edilir, kullanıcı 4 Türkçe anlam
//           seçeneğinden doğrusunu seçer. quiz_exercise_screen.dart'taki
//           4 şıklı yapıdan türetilmiştir (Hile Korumalı Dinamik
...
class _ListeningExerciseScreenState extends State<ListeningExerciseScreen> {
  ...
  String? _cheerToast;
  bool _hasRevealedWordThisQuestion = false;

  Timer? _questionTimer;
  double _timeRemaining = 14.0;
  ...
  void _loadOptionsForCurrent() {
    ...
    setState(() {
      ...
      _answered = false;
      _hasRevealedWordThisQuestion = false;
    });

    final currentWord = currentCard['word'] ?? '';
    // Sadece Dinleme'nin özü: yazı gösterilmez, otomatik seslendirme başlar.
  ...
  void _selectOption(String option) async {
    ...
    setState(() {
      ...
      _answered = true;
      _hasRevealedWordThisQuestion = true; // Cevap sonrası yazı gösterilir (öğretici geri bildirim)
    });
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          _hasRevealedWordThisQuestion ? currentWord : 'Kelimeyi dinle ve anlamını seç',
